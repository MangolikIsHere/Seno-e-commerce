-- ==============================================================================
-- SENO MARKETPLACE — FIX CHECKOUT VARIANT PRICE BUG
-- Migration: 20260918090003_fix_checkout_pv_price.sql
-- ==============================================================================
-- Fixes an issue where create_order referenced a non-existent pv.price column.
-- It now correctly uses pv.price_override.
-- ==============================================================================
